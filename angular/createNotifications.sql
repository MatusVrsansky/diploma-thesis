INSERT INTO `notifications` (`id`, `user_id`, `notification_type`, `temperature_notification`, `wind_speed_notification`, `rain_gauge_notification`, `wind_direction_notification`, `humidity_notification`, `pressure_notification`, `soil_temperature_notification`, `soil_mosture_notification`, `text_notification`, `active_notification`, `temperature_windSpeed_operator`, `description_notification`, `notification_sent`) VALUES
